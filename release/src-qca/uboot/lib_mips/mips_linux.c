...
#if defined(ASUS_PRODUCT) && defined(UBI_SUPPORT) && defined(DUAL_TRX)
#include <flash_wrapper.h>
#endif
		     ...
		     ulong addr, ulong * len_ptr, int verify)
{
	...
	if (!strstr(p, "board="))
#if defined(CONFIG_AP135)
		strcat(p, "board=AP135 ");
#elif defined(CONFIG_AP143)
		strcat(p, "board=AP143 ");
#elif defined(CONFIG_AP152)
		strcat(p, "board=AP152 ");
#else
#error Unknown model
#endif
	if (!strstr(p, "console="))
		strcat(p, "console=ttyS0,115200 ");
