...
#ifdef ATH_S17_MAC0_SGMII
//this also used in finish_s17_lpbk(). need sync to fix LAN performance down to 910Mbps issue.
    phyAddr = 4;
#else
    phyAddr = 0;
#endif
...
void finish_s17_lpbk(void)
{
    ...
    phyAddr = 0;
#endif
    phy_reg_write(0, phyAddr, 0x0, 0x8800);	// reset & power down
}
