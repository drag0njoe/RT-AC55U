...
ifeq ($(ASUS_PRODUCT),1)
PLATFORM_CPPFLAGS+= -DASUS_PRODUCT
endif

ifeq ($(DUAL_TRX),1)
PLATFORM_CPPFLAGS+= -DDUAL_TRX
endif

ifeq ($(HAVE_WAN_RED_LED),1)
PLATFORM_CPPFLAGS+= -DHAVE_WAN_RED_LED
endif

ifeq ($(LSDK_NART_SUPPORT),1)
PLATFORM_CPPFLAGS+= -DLSDK_NART_SUPPORT
endif

ifeq ($(PLC_PARTS),1)
PLATFORM_CPPFLAGS+= -DPLC_PARTS
endif

ifeq ($(RESCUE_BLINK_WIFI_LED),1)
PLATFORM_CPPFLAGS+= -DRESCUE_BLINK_WIFI_LED
endif
