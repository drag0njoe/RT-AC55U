...
#ifdef	CONFIG_PLN12 //PL-N12 temporarily config all ports connected to esw
#define AP143_MAC1_OFFSET		0x1002
static unsigned char eth0_tmp_mac[6] __initdata = { 0x00,0x00,0x00,0x11,0x22,0x33 };
#else
...
#ifdef	CONFIG_PLN12 //PL-N12 temporarily config all ports connected to esw
	ath79_init_mac(ath79_eth0_data.mac_addr, eth0_tmp_mac, 0);
#else
...
#ifndef	CONFIG_PLN12 //PL-N12 temporarily config all ports connected to esw
	ath79_switch_data.phy4_mii_en = 1;
#else
	ath79_switch_data.phy4_mii_en = 0;
#endif
