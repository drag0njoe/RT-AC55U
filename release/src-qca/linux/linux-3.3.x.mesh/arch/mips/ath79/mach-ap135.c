...
#define AP135_MAC0_OFFSET		0x1002 // eth0 is same as 2.4G
#define AP135_MAC1_OFFSET		0x5006 // eth1 is same as 5G
#define AP135_WMAC_CALDATA_OFFSET	0x1000
#define AP135_PCIE0_CALDATA_OFFSET	0x1000
#define AP135_PCIE1_CALDATA_OFFSET	0x5000

#define AP135_PLL_10	0x00001313

static struct ath79_caldata_fixup ap135_caldata = {
	.name = "Factory2",
	.wmac_caldata_addr = AP135_WMAC_CALDATA_OFFSET,
	.pcie_caldata_addr = { FIXUP_UNDEFINED, FIXUP_UNDEFINED },
	.mac_addr = { AP135_MAC0_OFFSET, AP135_MAC1_OFFSET },
};
...
{
#if defined(CONFIG_ATH79_DEV_SPI)
	ath79_register_m25p80(NULL);
#endif
#if defined(CONFIG_ATH79_DEV_NAND)
	ath79_register_nand();
#endif
	ath79_mtd_caldata_fixup(&ap135_caldata);
